...
/*        system.actorOf(Props.create(ValidationWorker.class), "validationWorker2" + port);
        ...
        system.actorOf(Props.create(ValidationWorker.class), "validationWorker6" + port);
        system.actorOf(Props.create(ValidationWorker.class), "validationWorker7" + port);
        system.actorOf(Props.create(ValidationWorker.class), "validationWorker8" + port);
        system.actorOf(Props.create(ValidationWorker.class), "validationWorker9"+ port);
